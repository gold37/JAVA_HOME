/*
	...
	== LinkedList == 
     1. 출력시 저장된 순서대로 나온다.
     2. 중복된 데이터를 저장할 수 있다.
     3. 데이터를 읽어오는 속도는 LinkedList 가  Array List 보다 상대적으로 느리다.
     4. 순차적으로 데이터를 추가/삭제하는 경우에는 LinkedList 가  Array List 보다 상대적으로 느리다.
     5. 일반적인 데이터 추가/삭제는 데이터 중간 중간마다 발생하므로 이러한 경우에는 LinkedList 가 Array List 보다 상대적으로 빠르다.    
     6. 결과값은 Array List 를 사용하든지 LinkedList 를 사용하든지 동일한 결과값을 가진다.
     7. LinkedList 보다는 Array List 를 사용하도록 하자. 
...
public class LinkedListMain {
	public static void main(String[] args) {
		...
		// 1. Member 클래스의 객체만을 저장할 수 있는 LinkedList 객체 memberList를 생성하시오.
		...
		memberList.add(new Member("less", "qwer1234$", "이순신")); // LinkedList는 중복된 데이터를 저장할 수 있다.
	...
	*/
	...
	// *** LinkedList 타입인 memberList에 새로운 Member 객체 추가시 
	...
	// *** LinkedList 타입인 memberList에 새로운 Member객체 삭제하기 *** 
	memberList.remove(3); 
	// 				  ▲ 삭제할 Member객체의 인덱스번호
